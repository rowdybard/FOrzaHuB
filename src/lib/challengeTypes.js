...
export const CHALLENGE_TYPES = {
  time_trial: {
    ...
    accent: '#22d3ee',
    tint: 'cyan',
    cover: 'from-cyan-500/[0.04] via-transparent to-transparent',
    unit: 'time',
    sort: 'asc',
  ...
  drift_score: {
    ...
    accent: '#e879f9',
    tint: 'fuchsia',
    cover: 'from-fuchsia-500/[0.04] via-transparent to-transparent',
    unit: 'points',
    sort: 'desc',
    metricLabel: 'Score',
  ...
  drag_time: {
    ...
    accent: '#fb7185',
    tint: 'rose',
    cover: 'from-rose-500/[0.04] via-transparent to-transparent',
    unit: 'time',
    sort: 'asc',
    metricLabel: 'Elapsed',
  ...
  photo_contest: {
    ...
    accent: '#818cf8',
    tint: 'indigo',
    cover: 'from-indigo-500/[0.04] via-transparent to-transparent',
    unit: 'votes',
    sort: 'desc',
    metricLabel: 'Votes',
  ...
  build_battle: {
    ...
    accent: '#fbbf24',
    tint: 'amber',
    cover: 'from-amber-500/[0.04] via-transparent to-transparent',
    unit: 'votes',
    sort: 'desc',
    metricLabel: 'Votes',
