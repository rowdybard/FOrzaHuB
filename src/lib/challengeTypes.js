...
export const CHALLENGE_TYPES = {
  time_trial: {
    ...
    accent: '#22d3ee',
    tint: 'cyan',
    cover: 'from-cyan-400/10 via-sky-500/5 to-transparent',
    unit: 'time',
    sort: 'asc',
  ...
  drift_score: {
    ...
    accent: '#e879f9',
    tint: 'fuchsia',
    cover: 'from-fuchsia-400/10 via-purple-500/5 to-transparent',
    unit: 'points',
    sort: 'desc',
    metricLabel: 'Score',
  ...
  drag_time: {
    ...
    accent: '#fb7185',
    tint: 'rose',
    cover: 'from-rose-400/10 via-orange-500/5 to-transparent',
    unit: 'time',
    sort: 'asc',
    metricLabel: 'Elapsed',
  ...
  photo_contest: {
    ...
    accent: '#818cf8',
    tint: 'indigo',
    cover: 'from-indigo-400/10 via-violet-500/5 to-transparent',
    unit: 'votes',
    sort: 'desc',
    metricLabel: 'Votes',
  ...
  build_battle: {
    ...
    accent: '#fbbf24',
    tint: 'amber',
    cover: 'from-amber-400/10 via-emerald-500/5 to-transparent',
    unit: 'votes',
    sort: 'desc',
    metricLabel: 'Votes',
