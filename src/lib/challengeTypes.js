...
export const CHALLENGE_TYPES = {
  time_trial: {
    ...
    proofHint: 'Upload a clip of the full lap ending on the results screen. Assists must match the rules.',
  },
  drift_score: {
    id: 'drift_score',
    label: 'Drift Score',
    ...
    proofHint: 'Clip the full run ending on the score tally screen. No rewind.',
  },
  drag_time: {
    id: 'drag_time',
    label: 'Drag Time',
    ...
    placeholder: '13.842',
    proofHint: 'Show the start line and the trap time at the finish in one clip.',
  },
  photo_contest: {
    id: 'photo_contest',
    label: 'Photo Contest',
