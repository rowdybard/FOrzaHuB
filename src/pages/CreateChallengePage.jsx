...
export default function CreateChallengePage() {
  ...
  return (
    <div>
      <Seo title={isEdit ? 'Edit Challenge' : 'Create a Tournament'} description={isEdit ? 'Edit your Forza Horizon tournament settings.' : 'Create a verified Forza Horizon tournament for your club. Time trials, drift, drag, photo contests, and build battles with custom rules and real prizes.'} path="/create" />
