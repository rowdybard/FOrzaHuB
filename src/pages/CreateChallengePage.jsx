...
export default function CreateChallengePage() {
  ...
  return (
    <div>
      <Seo title={isEdit ? 'Edit Challenge' : 'Create a Tournament'} description={isEdit ? 'Edit your Forza Horizon 6 tournament settings.' : 'Create a verified Forza Horizon 6 tournament for your club. Time trials, drift, drag, photo contests, and build battles with custom rules and community prizes.'} path="/create" />
                ...
                <div className="space-y-2">
                  {form.rules.map((rule, i) => (
                    <div key={i} className="flex items-center gap-2">
                      <span className="grid h-7 w-7 shrink-0 place-items-center rounded-lg bg-white/[0.06] font-num text-xs font-semibold text-zinc-400">
                        {i + 1}
                      </span>
                      <input
                        value={rule}
