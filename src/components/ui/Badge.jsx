...
export function Badge({ children, className, tone = 'neutral' }) {
  const tones = {
    neutral: 'border-white/[0.1] bg-white/[0.06] text-zinc-300',
    brand: 'border-brand-500/25 bg-brand-500/[0.1] text-brand-300',
    success: 'border-emerald-500/25 bg-emerald-500/[0.1] text-emerald-300',
    warn: 'border-amber-500/25 bg-amber-500/[0.1] text-amber-300',
    danger: 'border-rose-500/25 bg-rose-500/[0.1] text-rose-300',
  }
  return (
    <span
      className={cn(
...
export function TypeBadge({ typeId, className, withIcon = true, size = 'md' }) {
  ...
  return (
    <span
      className={cn(
        'inline-flex items-center gap-1.5 rounded border border-white/[0.1] bg-white/[0.06] font-medium uppercase tracking-wide text-zinc-300',
        sz,
        className,
      )}
    >
...
const STATUS = {
  live: {
    label: 'Live',
    dot: 'bg-emerald-400',
    cls: 'border-emerald-500/25 bg-emerald-500/[0.1] text-emerald-300',
    pulse: true,
  },
  upcoming: {
    label: 'Upcoming',
    dot: 'bg-sky-400',
    cls: 'border-sky-500/25 bg-sky-500/[0.1] text-sky-300',
  },
  reviewing: {
    label: 'Reviewing',
    dot: 'bg-amber-400',
    cls: 'border-amber-500/25 bg-amber-500/[0.1] text-amber-300',
  },
  closed: {
    label: 'Closed',
    dot: 'bg-zinc-500',
